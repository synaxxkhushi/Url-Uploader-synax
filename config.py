...
class Config(object):
    # Bot Information 
    TECH_VJ_BOT_TOKEN = os.environ.get("TECH_VJ_BOT_TOKEN", "7173479389:AAH7ZJGNPGOljFV7k0rI0PPX2ogS6ARFZEA")
    TECH_VJ_BOT_USERNAME = os.environ.get("TECH_VJ_BOT_USERNAME", "Urluploaderxv1Bot") # Bot username without @.
    
    # The Telegram API things
    TECH_VJ_API_ID = int(os.environ.get("TECH_VJ_API_ID", "24267726"))
    TECH_VJ_API_HASH = os.environ.get("TECH_VJ_API_HASH", "7500ba8248548cc3864bd033668f9a9a")
    ...
    tech_vj_update_channel = environ.get('TECH_VJ_UPDATES_CHANNEL', '-1002158023676') # your update channel id and make bot admin in update channel with full right
    ...
    TECH_VJ_TUTORIAL = os.environ.get("TECH_VJ_TUTORIAL", "https://t.me/Toutorialbysynax/3")
