...
ᴛʜɪs ʙᴏᴛ ɪs ᴘᴏᴡᴇʀᴇᴅ ʙʏ <a href="https://t.me/synaxbots">🇮🇳 sʏɴᴀx ʙᴏᴛs 🇮🇳</a></b>
"""

    TECH_VJ_HELP_TEXT = """
<b>🖍️ ғᴇᴀᴛᴜʀᴇs :-

🇮🇳 ᴜᴘʟᴏᴀᴅ <a href="https://t.me/synaxbots">ʏᴛ-ᴅʟᴘ sᴜᴘᴘᴏʀᴛᴇᴅ ʟɪɴᴋs</a> ᴛᴏ ᴛᴇʟᴇɢʀᴀᴍ.
...
🇮🇳 ʜᴏᴡ ᴛᴏ ᴜᴘʟᴏᴀᴅ ʏᴏᴜᴛᴜʙᴇ ʟɪɴᴋs <a href="https://t.me/Toutorialbysynax/4">ᴛᴜᴛᴏʀɪᴀʟ ᴠɪᴅᴇᴏ</a>
...
"""
    ...
    TECH_VJ_ABOUT_TEXT = """
<b>♻️ ᴍʏ ɴᴀᴍᴇ : sʏɴᴀx ᴜʀʟ ᴜᴘʟᴏᴀᴅᴇʀ🦋

🌀 ᴄʜᴀɴɴᴇʟ : <a href="https://t.me/synaxbots">sʏɴᴀx ʙᴏᴛs 🇮🇳</a>
...
🌸 ᴅᴇᴠᴇʟᴏᴘᴇʀ : <a href="https://t.me/sanatanisynax">sᴀɴᴀᴛɴɪ sʏɴᴀx 🇮🇳</a></b>
...
"""
    ...
    TECH_VJ_START_BUTTONS = InlineKeyboardMarkup(
        [[
            InlineKeyboardButton('🌸 ᴊᴏɪɴ ᴍʏ ᴜᴘᴅᴀᴛᴇ ᴄʜᴀɴɴᴇʟ 🌸', url='https://t.me/synaxbots')
        ], [
            ...
            InlineKeyboardButton('🇮🇳 ғᴏʟʟᴏᴡ ᴍᴇ ᴏɴ ɪɴsᴛᴀɢʀᴀᴍ 🇮🇳', url='https://instagram.com/sanatanisynax')
        ]]
    )
