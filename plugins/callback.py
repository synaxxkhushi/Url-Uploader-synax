        ...
        if Config.TECH_VJ_UPDATES_CHANNEL:
            ...
            try:
                ...
                if user.status == "kicked":
                    await update.message.edit(
                        text="Sorry Sir, You are Banned to use me. Contact my [owner](https://t.me/synaxchatrobot).",
                        disable_web_page_preview=True
                    )
                    return
                ...
                await update.message.edit(
                    text="Something went Wrong. Contact my [owner](https://t.me/synaxchatrobot).",
                    disable_web_page_preview=True
                )
                return
        await update.message.edit(
